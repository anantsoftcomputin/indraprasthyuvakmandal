...
class EnquiryController extends Controller
{
    ...
    public function storeFeedback(Request $request)
    {
        ...
        $savedData = $Feedbacksheet->saveDataToSheet($values);
         $msg="Name: ".$request->name." %0a Phone: ".$request->phone." %0a Number Of Tifin : ".$request->number_of_tifin." %0a No Of Rating %0a Quality : ".$request->quality."Start %0a Hygiene : ".$request->hygiene." Start %0a Punctuality :".$request->panchuality." Start %0a Remark : ".$request->remarks." %0a";
         return redirect("https://wa.me/918780899424?text=".$msg);
    }
